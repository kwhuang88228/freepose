#!/usr/bin/env python3
"""
inference_v2.py — End-to-end 6D object pose trajectory from an arbitrary video.

Usage:
    python inference/inference_v2.py --video /path/to/video.mp4
    python inference/inference_v2.py --video /path/to/video.mp4 --track_object "cup"
...
def main():
    ...
    stage1_cmd = ["python", "-m", "scripts.extract_proposals_ground_video", "--video", video]
