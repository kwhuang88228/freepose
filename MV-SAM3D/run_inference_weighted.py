...
def run_weighted_inference(
    ...
    """
    config_path = f"sam3d_objects/checkpoints/{model_tag}/pipeline.yaml"
...
Examples:
  ...
  python run_inference_weighted.py --input_path ./data --mask_prompt stuffed_toy --image_names 0,1,2,3 \
    ...
    parser.add_argument("--visualization_dir", type=str, default=None,
                        help="Override the base output directory (default: 'visualization/' relative to CWD). "
                             "Pass an absolute path to redirect all outputs (e.g. from an external pipeline).")
